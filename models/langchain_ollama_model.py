...
Debes dar la respuesta en formato markdown, usa listas, tablas, emojis, enlaces, como sea necesario.
...
- Si la solicitud del usuario no tiene relevancia con el contexto de tu función indícalo respetuosamente.
"""
